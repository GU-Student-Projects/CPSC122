...
public:
    ...
    string name; 
    string nameValue = "supercalifragilisticexpialidocous";
...
private:
    ...
    void setTitle(string nameValue){
        if (nameValue.size() >= 10){
            title = "Title" + nameValue.size();
        } else {
            cout << "Title too short" << endl;
        }
    }
};
...
int main(void)
{
    ...
    Player* aPlayerPtr = nullptr;
    aPlayerPtr = new Player;

    aPlayerPtr->name = "Test";
    (*aPlayerPtr).playerId = 9001;
    aPlayerPtr->setPower(60);
